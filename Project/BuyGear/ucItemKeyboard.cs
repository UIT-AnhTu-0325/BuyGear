...
namespace BuyGear
{
    public partial class ucItemKeyboard : UserControl
    {
        Form_Main parent;
        public ucItemKeyboard(Form_Main parent)
        {
            this.parent = parent;
            InitializeComponent();
        }
        public ucItemKeyboard()
        {
            InitializeComponent();
        }
        public string _loai;
        ...
        private void picProduct_Click(object sender, EventArgs e)
        {
            ...
            Form_SanPham frmspx = new Form_SanPham(_masp, this.parent) { Dock = DockStyle.Fill, TopLevel = false, TopMost = true };
